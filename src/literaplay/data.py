                ...
                "chapters": [
                    {
                        ...
                        "end_condition": ("Хъшовете запяват патриотична песен и вдигат Странджата на рамене."),
                        "max_turns": 15,
                    }
                ],
                ...
                "chapters": [
                    {
                        ...
                        "end_condition": ("Арсеналът на Македонски свършва и битката приключва от липса на барут."),
                        "max_turns": 12,
                    }
                ],
                ...
                "chapters": [
                    {
                        ...
                        "end_condition": ("Странджата предава реликвите на Бръчков с последното си благословение."),
                        "max_turns": 12,
                    }
                ],
                "max_turns_per_chapter": 12,
        ...
        "situations": [
            {
                ...
                "first_message": ("Борис... как е приемът? Всичко ли върви по план — твоят план, разбира се?"),
                "choices": [
...
""",  # noqa: E501
                "chapters": [
                    {
                        ...
                        "end_condition": (
                            "Ирина напуска салона сама, оставяйки Борис сред безсмисления блясък на приема."
                        ),
                        "max_turns": 18,
                    }
                ],
            ...
            },
            {
                ...
                "first_message": (
                    "Ей, другарю Морев! Добре дошъл в ада. Искаш ли да видиш колко печелиш на гърба на тия момичета?"
                ),
                "choices": [
...
""",  # noqa: E501
                "chapters": [
                    {
                        ...
                        "end_condition": (
                            "Борис напуска склада. Шаренков остава сред работничките — решен да продължи борбата."
                        ),
                        "max_turns": 15,
                    }
                ],
            ...
            },
            {
                ...
                "first_message": ("И така, Борис... свърши. Всичко, за което продаде себе си... свърши."),
                "choices": [
                ...
                "chapters": [
                    {
                        ...
                        "end_condition": ("Ирина напуска вилата завинаги, оставяйки Борис сам в тъмнеещата стая."),
                        "max_turns": 15,
                    }
                ],
                "max_turns_per_chapter": 15,
