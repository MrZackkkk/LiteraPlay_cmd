...
""",
        "chapters": [
            ...
            {
                "id": "ch2_zaptieta_flight",
                "title": "Бягство (Глава I–II) — Заптиетата идват",
                "setting": "Оборът, после задният двор и калните пътища",
                "character_mood": "уплашен, решителен, адреналин",
                "plot_summary": (
                    "Заптиета тропат на портата на Бай Марко. Иван чува шума "
                    "и трябва да избяга. Той се измъква от обора и изчезва в "
                    "нощта."
                ),
                "end_condition": "Иван се измъква навън и изчезва в нощта.",
                "max_turns": 10,
            },
            {
                "id": "ch3_arrival_byala_cherkva",
                "title": "Учителят (Глави III–V) — Пристигане в Бяла Черква",
                "setting": "Бяла Черква, училището, домът на Маринчо",
                "character_mood": "предпазлив, надяващ се, наблюдателен",
                "plot_summary": (
                    "Иван се установява като учител под фалшиво име. Среща "
                    "доктор Соколов, запознава се с Рада. Започва да подготвя "
                    "революционна дейност."
                ),
                "end_condition": (
                    "Иван е приет като учител и е направил първите контакти "
                    "с революционерите."
                ),
                "max_turns": 25,
            },
